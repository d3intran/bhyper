...
export function renderAboutSection() {
  ...
  container.innerHTML = `
    <div class="space-y-6">
      ...
      <!-- Header Banner -->
      <div class="surface-card hero-card p-5 sm:p-6">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <h2 class="text-lg font-bold text-ink mt-1 tracking-tight">Delta-Neutral Funding Arbitrage & Carry Engine</h2>
            <p class="text-xs text-ink-soft mt-1 max-w-2xl leading-relaxed">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="surface-card p-4 space-y-2.5">
          ...
          <h3 class="font-bold text-sm text-ink">1. Pure Delta Neutrality</h3>
          ...
          <div class="pt-2 border-t border-edge text-2xs font-num text-emerald-500 font-medium">
        ...
        <div class="surface-card p-4 space-y-2.5">
          ...
          <h3 class="font-bold text-sm text-ink">2. Asymmetric Settlement</h3>
          <p class="text-xs text-ink-mute leading-relaxed">
          ...
          <div class="pt-2 border-t border-edge text-2xs font-num text-cyan-500 font-medium">
        ...
        <div class="surface-card p-4 space-y-2.5">
          ...
          <h3 class="font-bold text-sm text-ink">3. Dynamic Opportunity Swapper</h3>
          <p class="text-xs text-ink-mute leading-relaxed">
          ...
          <div class="pt-2 border-t border-edge text-2xs font-num text-amber-500 font-medium">
      ...
      <!-- Execution Pipeline Architecture.
           The four stages are siblings on the canvas, not boxes inside a box —
           nesting containers here added depth without adding meaning. -->
      <div class="space-y-3">
        <h3 class="font-bold text-sm text-ink flex items-center space-x-2">
          <i data-lucide="cpu" class="w-4 h-4 text-emerald-500"></i>
          <span>Low-Latency Execution Pipeline</span>
        </h3>

        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">

          <div class="surface-card p-4 space-y-1.5">
            <div class="flex items-center space-x-1.5 text-cyan-400 font-semibold font-num">
              <span class="w-4 h-4 rounded-full bg-cyan-500/20 text-cyan-400 flex items-center justify-center text-2xs">1</span>
              <span>Tick Ingestion</span>
            </div>
            <p class="text-ink-mute text-xs leading-relaxed">
          ...
          <div class="surface-card p-4 space-y-1.5">
            <div class="flex items-center space-x-1.5 text-emerald-400 font-semibold font-num">
              <span class="w-4 h-4 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-2xs">2</span>
          ...
          <div class="surface-card p-4 space-y-1.5">
            <div class="flex items-center space-x-1.5 text-amber-400 font-semibold font-num">
              <span class="w-4 h-4 rounded-full bg-amber-500/20 text-amber-400 flex items-center justify-center text-2xs">3</span>
          ...
          <div class="surface-card p-4 space-y-1.5">
            <div class="flex items-center space-x-1.5 text-rose-400 font-semibold font-num">
              <span class="w-4 h-4 rounded-full bg-rose-500/20 text-rose-400 flex items-center justify-center text-2xs">4</span>
